...
class Fee():
    def __init__(self, master):
        ...
        def Receipt():
            ...
            self.Display.insert(
                END, '\tGrade\t          :' + self.branch.get() + '\n')
            self.Display.insert(
                END, '\tTerm \t        :' + self.sem.get() + '\n\n')
        ...
        # ==================================================Frames===================================================
        Main_Frame = Frame(self.master, bg='red')
        Main_Frame.grid()
        ...
        self.lblTitle = Label(Title_Frame, font=('arial', 40, 'bold'), text='FEE RECIPT',
                              bg='white', padx=13)
        ...
        self.branch_label = Label(Frame_1, text='Grade : ', font=(
            'arial', 14, 'bold'), bg='Navajo white')
        self.branch_label.grid(row=4, column=0, padx=15, sticky=W)

        self.sem_label = Label(Frame_1, text='Term : ', font=(
            'arial', 14, 'bold'), bg='Navajo white')
        ...
        self.branch_entry = ttk.Combobox(Frame_1, values=(' ', '1', '2', '3', '5','6', '7', '8', '9','10', '11', '12'),
        ...
        self.total_entry = Entry(Frame_1, font=(
            'arial', 14), width=10, textvariable=self.var_1)
