...
class Window_1:
    def __init__(self, master):
        self.master = master
        self.master.title(" GEM School Management ")
        ...
        self.Lbl_Title = Label(self.Frame, text ='GEM', font = ('Con Samos MS',55,'bold'), bg = 'white', fg = 'Black')
        self.Lbl_Title.grid(row = 0, column = 0, columnspan =3, pady = 40)
        
        self.Login_Frame_1 = LabelFrame(self.Frame, width = 1350, height = 600, relief = 'ridge', bg = 'skyblue', bd = 15,
                                        font = ('arial',20,'bold'))
        self.Login_Frame_1.grid(row = 1, column =0)
        self.Login_Frame_2 = LabelFrame(self.Frame, width = 1000, height = 600, relief = 'groove',bg = 'skyblue', bd = 15,
                                        font = ('arial',20,'bold'))
        self.Login_Frame_2.grid(row = 2, column = 0)


        #===================================================LABEL and ENTRIES=======================================================================
        self.Label_Username = Label(self.Login_Frame_1, text = 'Username', font = ('Gill Sans MT',20,'bold'), bg = 'skyblue', bd = 20)
        ...
        self.Label_Password = Label(self.Login_Frame_1, text = 'Password', font = ('Gill Sans MT ',20,'bold'), bg = 'skyblue', bd = 20)
    ...
    def Login(self):
        ...
        if (u == str('gemis123') and p == str('gemis123')):
            self.__menu__()
        else:
    ...
    def Exit(self):
        self.Exit = tkinter.messagebox.askokcancel("Login", "Confirm if you want to Exit")
        if self.Exit > 0:
            self.master.destroy()
            return
